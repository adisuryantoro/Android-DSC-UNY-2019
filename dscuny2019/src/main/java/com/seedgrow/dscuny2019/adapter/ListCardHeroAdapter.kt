...
import kotlinx.android.synthetic.main.item_list_with_cardview.view.*

class ListCardHeroAdapter(private val listHero: ArrayList<DataHeroModel>): RecyclerView.Adapter<ListCardHeroAdapter.ListCardViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListCardViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_list_with_cardview, parent, false)
